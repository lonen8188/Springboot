...
import org.zerock.boardboot.repository.GuestbookRepository;
...
public class GuestbookServiceImpl implements GuestbookService {
    ...
    private final GuestbookRepository repository;  // 반드시 final 처리
    ...
    public Long register(GuestbookDTO dto) {
        ...
        Guestbook entity = dtoToEntity(dto);   // dto로 받아서 entity로 변환 하여 제공
